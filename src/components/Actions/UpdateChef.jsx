...
// import '../../css/Actions/UpdateChef.css'; // Custom CSS for Chef Update
...
const ChefUpdate = () => {
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await axios.put(`https://localhost:7031/api/Chef/${user.id}`, data, {
        headers: {
  ...
  return (
    <div className="update-container">
      <div className="update-card">
        <h2 className="update-title">Update Your Chef Profile 👨‍🍳</h2>
